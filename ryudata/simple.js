...
Berikut List Menu Yang Tersedia Di *ZEXXO BOTZ MD*
...
exports.smenu = (pushname) => {
	return`Halo Kak *${pushname}* 👋
Saya Adalah *ZEXXO-BOTZ MD* Yang Direcode Oleh ZEXXO STORE Menggunakan Base Dari Dika Ardnt (Hisoka-Morou)
